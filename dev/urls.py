...
urlpatterns = [
  ...
  path('user/reset-password/', views.ResetpaswordRequestView.as_view(), name='request_otp'),
  path('user/reset-password/<str:username>/', views.ResetPasswordView.as_view(), name='reset_password'),
