...
from teaching_practice.models import Aspect, AssessmentType, Location, Section, Student, StudentAspect, StudentLetter, SubSection, ZonalLeader, Zone
...
admin.site.register(ZonalLeader)
